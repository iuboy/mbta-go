...
func BenchmarkWrite(b *testing.B) {
	...
	for b.Loop() {
		...
		if err := Write(&buf, Version, TypeBatch, FlagEnvelope|FlagData, ChannelData, payload); err != nil {
			b.Fatal(err)
		}
	}
}
...
func BenchmarkWriteDiscard(b *testing.B) {
	...
	b.ReportAllocs()
	for b.Loop() {
		if err := Write(io.Discard, Version, TypeBatch, FlagEnvelope|FlagData, ChannelData, payload); err != nil {
			b.Fatal(err)
		}
	}
}
