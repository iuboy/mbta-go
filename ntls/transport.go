...
func (s *Server) Start(ctx context.Context) error {
	return core.NewError(core.NumConfig, core.CodeConfig, "ntls server not yet implemented (requires NTLS/TLCP library)")
}
...
func (c *Client) Connect(ctx context.Context) error {
	return core.NewError(core.NumConfig, core.CodeConfig, "ntls client not yet implemented (requires NTLS/TLCP library)")
}
...
func (c *Client) SendBatch(ctx context.Context, batch *core.SignalBatch, tag, source string) (string, error) {
	return "", core.NewError(core.NumConfig, core.CodeConfig, "ntls send not yet implemented")
}
